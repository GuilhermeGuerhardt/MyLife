...
1. Baixe `Life_0.2.0_x64-setup.exe`.
2. Execute o arquivo.
...
Sai em `src-tauri/target/release/bundle/nsis/Life_0.2.0_x64-setup.exe`. O
...
Parcela escrita no nome (`CG 160 Fan (5/48)`) vira parcelamento de verdade, com as linhas do mesmo
