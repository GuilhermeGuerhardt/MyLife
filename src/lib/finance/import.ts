...
export function detectColumns(header: string[]): ColumnMap {
  ...
  // diferencia quatro cobranças idênticas da Serasa se perderia.
...
/**
 * Separa a parcela do nome: `CG 160 Fan (5/48)` vira `CG 160 Fan` + 5 de 48.
 *
...
/**
 * Limpa o rótulo da conta: `Conta - Banco Inter` vira `Banco Inter`.
 *
 * O prefixo é do app de origem, não do banco. Mantê-lo faria "Conta - Banco
 * Inter" e "Banco Inter" virarem duas contas diferentes na hora de casar.
 */
