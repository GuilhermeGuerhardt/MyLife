import { ArrowLeft, ExternalLink, ListPlus, NotebookPen, Pencil, Trash2 } from 'lucide-react'
        ...
        <div className="space-y-4">
          {modules.map(([moduleName, items]) => {
            ...
            return (
              <Card key={moduleName}>
                <CardHeader
                  title={moduleName || 'Sem módulo'}
                  description={`${moduleDone} de ${items.length} aulas`}
                  action={
